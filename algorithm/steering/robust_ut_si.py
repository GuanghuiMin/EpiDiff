...
def map_estimate_eta_fixed_init(
    ...
    inits = [
        np.array([mid_R, mid_T]), 
        np.array([adaptive_logR0, mid_T]), 
        np.array([np.log(1.2), np.log(6.0)]),
        np.array([np.log(2.5), np.log(3.5)]), 
        np.array([np.log(1.8), np.log(4.5)]), 
        np.array([lbR + 0.2*(ubR-lbR), lbT + 0.8*(ubT-lbT)]),
        np.array([ubR - 0.2*(ubR-lbR), ubT - 0.2*(ubT-lbT)]),
    ]
